...
function rotate {
	...
	bottom-up)
		...
		#gsettings set com.canonical.Unity.Launcher launcher-position Top
        touch_orientation="cw"
		;;
	right-up)
		NEW_ROT="right"
		CTM="0 1 0 -1 0 1 0 0 1"
		#gsettings set com.canonical.Unity.Launcher launcher-position Left
        touch_orientation="cww"
		;;
	left-up)
		NEW_ROT="left"
		CTM="0 -1 1 1 0 0 0 0 1"
		#gsettings set com.canonical.Unity.Launcher launcher-position Left
        touch_orientation="half"
		;;
	esac
	...
	#echo CTM:     $CTM
		...
		xinput set-prop INDEV_STYLUS --type=float 'Coordinate Transformation Matrix' $CTM
		xinput set-prop INDEV_TOUCH --type=float 'Coordinate Transformation Matrix' $CTM
		xinput set-prop INDEV_ERASER --type=float 'Coordinate Transformation Matrix' $CTM
        #sudo xsetwacom set 10 Rotate $touch_orientation
	#	fi
